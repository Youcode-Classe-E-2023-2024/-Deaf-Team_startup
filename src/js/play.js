    ...
    function updateProgress(time) {
        progressBar.value = time; // time music 
    ...
    // Récupérez la valeur actuelle de la barre de progression
    let newTime = parseFloat(progressBar.value);

    // Mettez à jour le temps de lecture de la musique
    footerMusic.currentTime = newTime;
});
    ...
    if (event.code === "Space") {
        ...
        event.preventDefault(); // Prevent the default behavior of spacebar (e.g., scrolling)
        
        if (footerMusic.paused) {
